...
public class Explicitwait_Fluentwait {
	...
	{
		//Explicit wait defined using fluent wait
		FluentWait<WebDriver> fwait=new FluentWait<WebDriver>(driver).withTimeout(90,TimeUnit.SECONDS).pollingEvery(2,TimeUnit.SECONDS).ignoring(NoSuchElementException.class);
