...
public class LoginusingKeywords {
	...
	{
		FileInputStream f1=new FileInputStream("E:\\10OnlineSession\\SeleniumProject\\Gmail.properties");
		Properties pr=new Properties();
		pr.load(f1);
		LoginActions keys=new LoginActions();
		FileInputStream f=new FileInputStream("E:\\10OnlineSession\\SeleniumProject\\src\\com\\shubhsolutions\\keywords\\LoginKeywords.xlsx");
